...
public class coinPressContainer extends Container {
	 protected TileCoinPress tile_entity;
	    
	    public coinPressContainer(TileCoinPress tile_entity, InventoryPlayer player_inventory)
	    {
			...
			//Bucket Slot
			this.addSlotToContainer(new SlotSpecific(tile_entity, 6, 49, 38,new ItemStack(murderCoins.meltedBucket)));
