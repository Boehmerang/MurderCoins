...
public class containerWindmillBase extends Container {
    protected tileEntityWindmillBase tile_entity;

    public containerWindmillBase(tileEntityWindmillBase tile_entity, InventoryPlayer player_inventory)
    {
