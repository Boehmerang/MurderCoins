...
public class blockBasicTrader extends BlockAdvanced
{
	...
	private Icon bTraderFront;

	public blockBasicTrader(int id)
	{
	...
	{
		this.bTraderTop = par1IconRegister.registerIcon("MurderCoins:vaultTop");
		this.bTraderFront = par1IconRegister.registerIcon("MurderCoins:traderFront");
	}
	@Override
	public Icon getBlockTexture(IBlockAccess world, int x, int y, int z, int side)
	{
		...
		{
			return this.bTraderFront;
		}
		else
		// sides
		{
			return this.bTraderTop;
		}
	}
	@Override
	...
	public void onBlockPlacedBy(World par1World, int x, int y, int z, EntityLiving par5EntityLiving, ItemStack itemStack)
	{
        ...
        if (par5EntityLiving instanceof EntityPlayer && (TileEntityAdvanced) par1World.getBlockTileEntity(x, y, z) instanceof tileEntityBasicTrader)
        {
            ((tileEntityBasicTrader) par1World.getBlockTileEntity(x, y, z)).setOwners(par5EntityLiving.getEntityName(), 1);
        }
	...
	{
		return new tileEntityBasicTrader();
	}
}
